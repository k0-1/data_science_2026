...
$$ \begin{pmatrix} 1 & -1 & 1 \\\ 1 & 1 & 1 \\\ 4 & 2 & 1 \end{pmatrix} \begin{pmatrix} a \\\ b \\\ c \end{pmatrix} = \begin{pmatrix} 0 \\\ 2 \\\ 9 \end{pmatrix} $$
...
$$ \begin{cases}a+b+c=6 \\\ 2a-b+c=3 \\\ a+2b-c=2 \end{cases} $$
